...
task_logger.create_log_file_by_rotate_handler('git_tasks.log')
...
START_TASK_DELAY = timedelta(seconds=60)


def reg_git_task(bot: Bot):
    @bot.task.add_interval(hours=1, start_date=datetime.now() + START_TASK_DELAY)
